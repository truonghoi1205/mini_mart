                        ...
                        <div class="row g-4">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <ul class="list-unstyled fruite-categorie">
                                        ...
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Dâu</a>
                                                <span>(2)</span>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Nho</a>
                                                <span>(5)</span>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="range" class="form-range w-100" id="rangeInput" name="rangeInput" min="0" max="1500000" value="0" oninput="amount.value=rangeInput.value">
                                    <output id="amount" name="amount" min-value="0" max-value="500" for="rangeInput">0</output> <span>đ</span>
                                </div>
                            </div>
                            <div class="col-lg-12">
